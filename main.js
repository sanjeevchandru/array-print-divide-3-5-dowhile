//How many numbers are divisible by 3 and 5 in given array using do-while

document.write("How many numbers are divisible by 3 and 5 in given array using do-while"+"<br>");
